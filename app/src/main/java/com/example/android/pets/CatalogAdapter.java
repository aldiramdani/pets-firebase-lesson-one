...
public class CatalogAdapter extends RecyclerView.Adapter<CatalogAdapter.ViewHolder> {
    ...
    public CatalogAdapter(Context context, ArrayList<Pet> data,View mEmptyView, ClickHandler handler) {
        mContext = context;
        mData = data;
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener {
        ...
        @Override
        public void onClick(View itemView) { mClickHandler.onItemClick(getAdapterPosition());
        }
