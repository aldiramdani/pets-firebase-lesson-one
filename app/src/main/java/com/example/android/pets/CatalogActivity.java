...
public class CatalogActivity extends AppCompatActivity {
    ...
    private ActionMode.Callback mActionModeCallback = new ActionMode.Callback() {
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            actionMode.getMenuInflater().inflate(R.menu.catalog_context,menu);
            return true;
        }

        @Override
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            actionMode.setTitle(String.valueOf(mAdapter.selectionCount()));
        ...
        builder.setTitle(R.string.add_pet)
                ...
                .setPositiveButton(R.string.save, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        TextView nameTextView = view.findViewById(R.id.nama_edit_text);
                        TextView breedTextView = view.findViewById(R.id.breed_edit_text);
                        mData.add(new Pet(nameTextView.getText().toString(),
    ...
    private void editPet(){
        ...
        final TextView nameTextView = view.findViewById(R.id.nama_edit_text);
